...
#ifndef DFMC_EGLHELPER_NATIVEWINDOWX11_HPP
#define DFMC_EGLHELPER_NATIVEWINDOWX11_HPP
// ----------------------------------------------------------------------------
...
namespace eglhelper
{
  class NativeNativeWindowX11 : public INativeWindow
  {
    EGLNativeDisplayType mhDisplay;
  ...
  public:
    ...
    NativeWindowX11(const EGLNativeDisplayType hDisplay, const RenderConfig& renderConfig, const EGLDisplay& eglDisplay, const EGLConfig& config);
    virtual ~NativeWindowX11();
