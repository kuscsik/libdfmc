...
#ifndef DFMC_EGLHELPER_NATIVEWINDOWSURFACEFLINGER_HPP
#define DFMC_EGLHELPER_NATIVEWINDOWSURFACEFLINGER_HPP
// ----------------------------------------------------------------------------
...
namespace eglhelper
{
  class NativeWindowSurfaceFlinger : public INativeWindow
  {
  ...
  public:
    ...
    NativeWindowSurfaceFlinger(const EGLNativeDisplayType hDisplay, const RenderConfig& renderConfig, const EGLDisplay& eglDisplay, const EGLConfig& config);
    virtual ~NativeWindowSurfaceFlinger();
