#ifdef DFMC_HAS_GLUT
#ifndef DFMC_DEMO_DEMOGLUT_HPP
#define DFMC_DEMO_DEMOGLUT_HPP
// ----------------------------------------------------------------------------
...
namespace dfmc
{
    ...
    , private Noncopyable
  {
    ...
    DFMC::shared_ptr<DemoAppController> mAppController;
  public:
    DemoGlut(const DemoConfig& demoConfig, IDemoController& demoController);
    virtual ~DemoGlut();
